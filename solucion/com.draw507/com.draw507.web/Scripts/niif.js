var InitApp = (function (window, undefined) {
    ...
    var advertencia = function () {
        ...
        console.log('%cEsta función del navegador está pensada para desarrolladores. Si intentas "hackear" este sitio com.draw507.web podrá deshabilitar tus credenciales de acceso.', 'color:black;font-size:large;');
    };
